//
//  MODEL_Y_2021_PRODUCT.swift
//  TDB
//
//  Created by Trevor Bays on 7/10/21.
//

let MODEL_Y_2021_PRODUCT = Product(
    title: ProductTitle(nameFull: "Model Y", nameShort: "Model Y", year: "2020"),
    thumbnail: "MODEL_Y_THUMBNAIL",
    model_dae: "f40.dae",
    model_usdz: "f40.usdz",
    model_height: 170,
//    preview_w: 380,
...
//    ],
    ...
    trims: [
        ...
        ProductTrim(title: "Performance", index: 1)
    ],
    sections: [
        ProductSection(header: "OVERVIEW", rows: [
            ...
            ProductRow(title: "Base price (US)", values: ["$52,990", "$60,990"]),//here
        ]),
        ProductSection(header: "BODY AND CHASSIS", rows: [
            ...
            ProductRow(title: "Layout", values: ["Dual-motor all-wheel drive (D models)"]),
...
let MODEL_Y_PRODUCTS = ProductList(
    products: [
        MODEL_Y_2021_PRODUCT
    ],
    years: ["A45F":0],
    yearsSpan: "2020 - present",
    productDisabled: false,
    useHeader: "",
    productID: ProductIdentifier._y,
