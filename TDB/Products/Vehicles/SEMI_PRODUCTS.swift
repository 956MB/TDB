...
//  TDB
//
//  Created by Trevor Bays on 11/14/21.
//

let SEMI_2022_PRODUCT = Product(
    title: ProductTitle(nameFull: "Semi", nameShort: "Semi", year: "2022"),
    thumbnail: "SEMI_THUMBNAIL",
    model_dae: "gtr.dae",
    model_usdz: "gtr.usdz",
    model_height: 175,
//    preview_w: 380,
...
let SEMI_PRODUCTS = ProductList(
    ...
    useHeader: "",
    productID: ProductIdentifier._semi,
