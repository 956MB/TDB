//
//  ROADSTER_PRODUCTS.swift
//  TDB
//
//  Created by Trevor Bays on 7/12/21.
//

let ROADSTER_2022_PRODUCT = Product(
    title: ProductTitle(nameFull: "Roadster", nameShort: "Roadster", year: "2022"),
    thumbnail: "ROADSTER_THUMBNAIL",
    model_dae: "roadster.dae",
    model_usdz: "roadster.usdz",
    model_height: 120,
//    preview_w: 420,
//    preview_h: 175,
//    header_min_h: 240,
...
//    ],
    ...
    trims: [
        ProductTrim(title: "Roadster", index: 0),
        ProductTrim(title: "Founders Series", index: 1)
    ],
    sections: [
...
let ROADSTER_2008_PRODUCT = Product(
    title: ProductTitle(nameFull: "Roadster", nameShort: "R", year: "2008"),
    thumbnail: "ROADSTER_THUMBNAIL",
    model_dae: "roadster.dae",
    model_usdz: "roadster.usdz",
    model_height: 120,
...
//    ],
    ...
    sections: [
        ProductSection(header: "OVERVIEW", rows: [
            ProductRow(title: "Manufacturer", values: ["Tesla, Inc."]),
            ProductRow(title: "Production", values: ["2008 - 2012"]),
//            ProductRow(title: "Also called", values: ["Cybrtrk"]),
//            ProductRow(title: "Assembly", values: ["United States: Fremont, California (Tesla Factory)\nChina: Shanghai (Gigafactory 3)"]),
            ProductRow(title: "Designer", values: ["Franz von Holzhausen"]),
            ProductRow(title: "Base price (US)", values: ["$200,000", "$250,000"]),
...
let ROADSTER_PRODUCTS = ProductList(
    products: [
        ROADSTER_2022_PRODUCT,
        ROADSTER_2008_PRODUCT
    ],
    years: ["6F21":0, "BB4F":1],
    yearsSpan: "2008 - 2012, 2022 (to commence)",
    productDisabled: false,
    useHeader: "",
    productID: ProductIdentifier._roadster,
